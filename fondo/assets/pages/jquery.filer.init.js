...
$(document).ready(function(){
    ...
    $("#filer_input1").filer({
        ...
        onRemove: function(itemEl, file, id, listEl, boxEl, newInputEl, inputEl){
            var file = file.name;
            $.post('http://coderthemes.com/ubold_2.3/plugins/jquery.filer/php/remove_file.php', {file: file});
        },
        onEmpty: null,
        options: null,
        captions: {
            ...
            feedback2: "file(s) were chosen",
            drop: "Drop file here to Upload",
            removeConfirmation: "Are you sure you want to remove this file?",
            errors: {
                filesLimit: "Only {{fi-limit}} files are allowed to be uploaded.",
                filesType: "Only .pdf extensions are allowed to be uploaded.",
